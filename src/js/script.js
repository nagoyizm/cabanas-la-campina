...
const suitesInfo = {
    ...
    'Balcón de 1 a 2 personas': {
        ...
        parrafo: `<br>Se encuentra en un 2do piso con balcón, vista al jardín y piscina (verano), y cuenta con una cama de dos plazas, espacio con lavaplatos y mueble para loza, un baño con ducha, y una mesita con dos sillas. (<i>opción de cama inflable extra por costo adicional y según disponibilidad</i>). <b>No admite mascotas</b>. <br><br><strong>Incluye:</strong><br>-Ropa de cama, juego de toallas (de cuerpo x2, de mano x1, de pie x1), y secador de cabello. <br>-Rollo de papel higiénico(x1), jabón líquido(20ml), shampoo/acondicionador(20ml) y crema humectante(20ml). <br>-Vajilla, frigobar, y detergente lavalozas. <br>-Televisor con DirecTV y ventilador. <br>-Acceso a quinchos grandes con comedores comunitarios al exterior y coffee bar de cortesía en área común interior. <br>-Estacionamiento. <br>-Acceso a juegos infantiles. <br>-Acceso a piscinas al aire libre (10:30~20:30hrs) <b>SOLO desde diciembre hasta Semana Santa</b>. <br><br> <strong>IMPORTANTE: Se solicitará una GARANTÍA DE $20.000, la cual será reembolsada al momento de la entrega de llaves y tras la revisión del inmueble. Las suites no disponen de conexión Wi-Fi. Se prohíben los ruidos y la música a alto volumen; a partir de las 21:00 horas, se solicita mantener el silencio para favorecer el descanso de todos los huéspedes. Por seguridad, no se permite conectar aparatos de alto consumo eléctrico.</strong><br><br>`
    },
    'Clásica de 1 a 2 personas': {
        imagenes: [
        ...
        parrafo: `<br>Se encuentra en un 2do piso con vista trasera, y cuenta con una cama de dos plazas, espacio con lavaplatos y mueble para loza, un baño con ducha, y una mesita con dos sillas. (<i>opción de cama inflable extra por costo adicional y según disponibilidad</i>). <b>No admite mascotas</b>. <br><br><strong>Incluye:</strong><br>-Ropa de cama, juego de toallas (de cuerpo x2, de mano x1, de pie x1), y secador de cabello. <br>-Rollo de papel higiénico(x1), jabón líquido(20ml), shampoo/acondicionador(20ml) y crema humectante(20ml). <br>-Vajilla, frigobar, y detergente lavalozas. <br>-Televisor con DirecTV. <br>-Acceso a quinchos grandes con comedores comunitarios al exterior y coffee bar de cortesía en área común interior. <br>-Estacionamiento. <br>-Acceso a juegos infantiles. <br>-Acceso a piscinas al aire libre (10:30~20:30hrs) <b>SOLO desde diciembre hasta Semana Santa</b>. <br><br> <strong>IMPORTANTE: Se solicitará una GARANTÍA DE $20.000, la cual será reembolsada al momento de la entrega de llaves y tras la revisión del inmueble. Las suites no disponen de conexión Wi-Fi. Se prohíben los ruidos y la música a alto volumen; a partir de las 21:00 horas, se solicita mantener el silencio para favorecer el descanso de todos los huéspedes. Por seguridad, no se permite conectar aparatos de alto consumo eléctrico.</strong><br><br>`
    }
};
...
const parrafoAmenidades = `
    ...
    🧼👕 <strong>SERVICIO DE LAVANDERÍA: $5.000 por bolsa (40x30x120cm). <br>Horario de servicio: 10:30hrs – 15:30hrs.</strong> <br>Incluye detergente, lavado, secado al aire libre, y doblado sin planchar (<b>NO SE RECIBE ROPA INTERIOR</b>). Una vez solicitado el servicio, le será entregada la bolsa en su cabaña/suite para que puedan llenarla con la ropa a lavar.<br><br>
    🧹 <strong>SERVICIO DE LIMPIEZA: $10.000. <br>Horario de servicio: 10:30hrs – 15:30hrs.</strong> <br>Incluye barrido general interior y terraza, orden de cama, aseo de baños con recambio de toallas y reposición de papel higiénico y amenidades. (<b>No se lava loza</b>).<br><br>
    ♟🧩 <strong>JUEGOS DE MESA: !Te los prestamos por 2 horas sin costo! <br>Horario de servicio: 11:00 – 20:00hrs</strong> <br>Simplemente avisar por WhatsApp y acércarse a recepción para retirar el juego (máx. 2 por cabaña/suite). 
    Al pasar las 2 horas, puedes consultar por WhatsApp para seguir usándolo por 2 horas adicionales según disponibilidad. <i>Luego de las 20:00hrs se devuelve al día siguiente</i>.
   <br><strong>Al devolverlo, debes entregarlo en las mismas condiciones y completo para la devolución de garantía, de lo contrario, se cobrará parte de la garantía.</strong><br><br>
   `;
