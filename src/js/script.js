...
const parrafoAmenidades = `
    ...
    🧼👕 <strong>SERVICIO DE LAVANDERÍA: $5.000 por bolsa (40x30x120cm). <br>Horario de servicio: 10:30hrs – 15:30hrs.</b></strong> <br>Incluye detergente, lavado, secado al aire libre, y doblado sin planchar <br><b>NO SE RECIBE ROPA INTERIOR, NI ROPA CON RESIDUOS BIOLÓGICOS (excremento, orina o sangre)</b>). residuos biológicos (como excremento, orina o sangre)Una vez solicitado el servicio, le será entregada la bolsa en su cabaña/suite para que puedan llenarla con la ropa a lavar.<br><br>
